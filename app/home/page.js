    ...
    <header className={cn('fixed top-0 inset-x-0 z-50 transition-all', scrolled ? 'py-2' : 'py-4')}>
      <div className={cn('container flex items-center justify-between rounded-full px-6 py-3 transition-all',
        ...
        <div className="flex items-center gap-2">
          ...
          <Button asChild variant="ghost" className="hidden md:inline-flex text-burgundy hover:bg-burgundy/5 rounded-full"><a href="/">Log in</a></Button>
          <Button asChild className="rounded-full bg-burgundy hover:bg-burgundy-600 text-white px-5"><a href="/">Sign up</a></Button>
